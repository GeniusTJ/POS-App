...
const FoodTypeTile = (props) => {
  ...
  return (
    <div onClick={()=>{alert('clicked');}} className={classes.outer} onMouseEnter={mouseEnterHandler}
    onMouseLeave={mouseLeaveHandler} style={{backgroundColor:!mouseState? props.defColor : props.onColor}}>
